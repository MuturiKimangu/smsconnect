            ...
            <div class="card bg-progradient">
                    ...
                    <div class="card-content">
                        ...
                        <div class="col-xl-6 col-12">
                                  <h2 class="fs-24 font-w700 text-white">Manage your project in one touch</h2>
...
@section('page-script')
    ...
    tour.addStep('step-1', {
        text: 'Thank you for choosing Ultimate SMS!<br><br>' +
            ...
            'If you ever need support, please send email to <code>rizwange4@gmail.com@gmail.com</code><br><br>' +
            'Let\'s get started!',
        buttons: [
